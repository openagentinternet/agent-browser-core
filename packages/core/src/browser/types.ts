...
export function browserCommandSuccess<T>(data: T): BrowserCommandSuccess<T> {
  return { ok: true, state: 'success', data };
}

export function browserCommandFailed(
  code: string,
  message: string,
  data?: Record<string, unknown>,
