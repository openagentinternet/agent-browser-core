...
function selectUrl(record: MetaAppGalleryRecord): string | undefined {
...
function selectRendererType(record: MetaAppGalleryRecord, url: string | undefined): BrowserRendererType {
