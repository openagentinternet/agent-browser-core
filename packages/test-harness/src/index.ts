...
const RESOURCE_TYPES = ['bot', 'metaapp', 'document', 'image', 'pdf', 'unsupported', 'unknown'];
const OWNER_KINDS = ['bot', 'metaapp-publisher', 'wallet-user', 'unknown'];
const RENDERER_TYPES = ['bot-page', 'html-iframe', 'pdf', 'image', 'video', 'unsupported'];
const RESOLUTION_STATES = ['resolved', 'loading', 'not_found', 'error'];
const VERIFICATION_STATES = ['verified', 'partial', 'unverified'];
const RESOURCE_ACTION_KINDS = ['private-chat', 'service-list', 'service-call', 'copy', 'proof', 'creator'];
