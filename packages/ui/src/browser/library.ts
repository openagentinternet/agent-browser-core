export const BROWSER_LIBRARY_MESSAGE_VERSION = 1 as const;

export const BROWSER_LIBRARY_REQUEST_TYPES = {
...
export type BrowserLibraryRequestType =
  (typeof BROWSER_LIBRARY_REQUEST_TYPES)[keyof typeof BROWSER_LIBRARY_REQUEST_TYPES];
