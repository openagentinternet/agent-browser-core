  ...
  return `<section class="browser-shell" data-browser-shell>
      <header class="browser-topbar" data-browser-topbar>
        <nav class="browser-nav" aria-label="Browser navigation">
          <button type="button" class="browser-icon-button" aria-label="Back" data-browser-back disabled aria-disabled="true"></button>
          <button type="button" class="browser-icon-button" aria-label="Forward" data-browser-forward disabled aria-disabled="true"></button>
      ...
      <div class="browser-owner-toolbar" data-browser-owner-toolbar aria-label="Resource owner actions" hidden></div>
      <div class="browser-viewport-row" data-browser-viewport-row>
        <aside class="browser-drawer" data-browser-drawer aria-label="Resources" hidden></aside>
        <main class="browser-viewport" data-browser-viewport>${input.initialResourceHtml}</main>
        <aside class="browser-inspector" data-browser-inspector aria-label="Inspector" hidden></aside>
      </div>
